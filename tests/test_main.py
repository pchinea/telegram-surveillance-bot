...
def test_main(
    ...
    """
    mocker.patch('src.__main__.BOT_API_TOKEN', 'FAKE_TOKEN')
    mocker.patch('src.__main__.AUTHORIZED_USER', 'FAKE_USER')
    mocker.patch('src.__main__.BOT_LOG_LEVEL', 'INFO')
    mocker.patch('src.__main__.bot.Updater')
